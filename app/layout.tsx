  ...
  return (
    ...
    <body className="font-sans text-stone-900 bg-[#fcfaf6]">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white shadow-lg transition-colors mb-20 sm:mb-6"
      >
